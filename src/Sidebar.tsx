    ...
    <div className="fixed h-full top-0 left-0 w-64 flex-shrink-0">
      <div className="md:hidden">
        <button
          ...
          className={`z-50 top-5 left-5 ${isOpen ? "hidden" : "block"}`}
        >
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      <div
        className={`absolute md:relative top-0 left-0 z-40 w-60 h-full bg-gray-900 text-white transition-transform duration-300 transform ${
